...
SERVER_COMMANDS = {
	...
	'unikraft': ['sudo', './unikraft/run.sh', '1'],
	'unikraft-ovs': ['sudo', './unikraft/run_ovs.sh', '1'],
	'osv': ['sudo', OSV_PATH + '/modules/throughput/run.sh', '1'],
...
CLIENT1_COMMANDS = {
	...
	'unix': ['./process/build/throughput', '-u'],
	'skmsg': ['sudo', './process/build/throughput', '-l', '-m'],
	'unikraft': ['sudo', './unikraft/run.sh', '2'],
	'unikraft-ovs': ['sudo', './unikraft/run_ovs.sh', '2'],
	'osv': ['sudo', OSV_PATH + '/modules/throughput/run.sh', '2'],
	'osv-ovs': ['sudo', OSV_PATH + '/modules/throughput/run_ovs.sh',
		    '2'],
}
CLIENT2_COMMANDS = {
